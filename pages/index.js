        ...
        {/*<PobCode></PobCode>*/}
                      ...
                      <Stack gap={1} className="px-2 align-items-center mx-auto">
                          ...
                          <hr/>
                              ...
                              <div >
                                  ...
                                  <div><span className={"bg-success"} > Gain 1% of Cold Damage as Extra Fire Damage per 1% Chill Effect on Enemy </span> </div>
                                  <div><span className={"bg-success"} > Gain 30% of Cold Damage as Extra Fire Damage against Frozen Enemies </span> </div>
          ...
          <Row xs={1} md={3} lg={5} className="g-4 justify-content-center">
              <Card border="primary" bg="dark" text="white" style={{width: '18rem'}}>
                  ...
                  <Stack gap={1} className="px-2 align-items-center mx-auto">
                      ...
                      <div >
                           <div> <span className={"bg-success"}>   Gems can be Socketed in this Item ignoring Socket Colour</span> </div>
                          <div> <span className={"bg-success"}>   Gems Socketed in Red Sockets have +2 to Level</span></div>
                          <div> <span className={"bg-success"}>   Gems Socketed in Green Sockets have +30% to Quality</span></div>
                          <div> <span className={"bg-success"}>   Gems Socketed in Blue Sockets gain 100% increased Experience</span></div>
          ...
          <Row xs={1} md={3} lg={5} className="g-4 justify-content-center">
              <Card border="primary" bg="dark" text="white" style={{width: '18rem'}}>
                  ...
                  <Stack gap={1} className="px-2 align-items-center mx-auto">
                      <div>
                          <span className={"bg-success"}>10% of Physical Damage Converted to Lightning Damage</span>
              ...
              <Card border="primary" bg="dark" text="white" style={{width: '18rem'}}>
                  ...
                  <Stack gap={1} className="px-2 align-items-center mx-auto">
                      ...
                      <div >
                          ...
                          <div><span>Your Maximum Frenzy Charges is equal to your Maximum Power Charges</span></div>
                          <div><span>10% increased Cooldown Recovery Rate of Travel Skills per Frenzy Charge</span></div>
